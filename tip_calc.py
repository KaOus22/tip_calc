...
print(input(f"Your meal is ${bill:.2f} and you chose to give a {tip} percent tip. Which equals to a ${bill_amt_with_tip:.2f} tip. With taxes your bill equals {total:.2f}.. You and your company will need to fork over ${total/total_ppl_splitting:.2f} each.. Pay Up!"))
